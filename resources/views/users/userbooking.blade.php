            ...
            @if (!$morethandays )
                ...
                <div class="card">
                    <div class="card-header">
                        <b><i class="fas fa-book"></i> Booking
                        </b>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title"><i class="fas fa-calendar-alt"></i>
                            {{ $book->event_type }}</h5>
                        <p class="card-text"><i class="fas fa-arrow-right"></i>
                            In this Event Food {{ $book->food }} and Total People
                            {{ $book->no_people }}
                        </p>
                        <div class="lefttime">
                        <a href="#"
                            class="btn btn-primary"><i class="fas fa-calendar"></i>
                            {{ \Carbon\Carbon::parse($book->date)->format('d-m-Y') }}</a>
                            {{-- {{dd($date)}} --}}
                        @if ($book->date < $today)
                            <a href="#" class="btn btn-primary">Complated</a>
                        @else
